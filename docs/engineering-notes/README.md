...
收纳重大改造的**设计 / 实现计划 / 复盘**记录,作为日后提炼工程经验的素材库。

每次大改造一组文档,命名 `YYYY-MM-DD-<主题>-<类型>.md`(类型:`design` / `plan` / `retro`)。
...
| 2026-06-07 | 工作流视图重做:横向阶段步进器 + Stage D 数据迁移(合体) | [design](2026-06-07-workflow-stepper-redesign-design.md) |
